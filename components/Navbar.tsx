                   ...
                   <Link to="experience"
                    ...
                    >
                     ...
                     <div className="border-r border-gray-100 pr-4 flex items-center">
                        <a href="https://drive.google.com/file/d/1sAP8MyrbRANs-Cwxi_VY3onyfLw5Y60C/view?usp=drive_link"
                         target="_blank"
                         >
                     ...
                     <Link to="contact"
                        ...
                        spy={true}
                        offset={-100}
                      className="border border-gray-200 bg-white rounded-md px-2 py-1 transition-transform duration-300 hover:scale-105">
                        Contact
                     </Link>
